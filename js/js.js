...
//------------------ 样式定义 ---------------------------//
//功能按钮同样样式
var s_sss_turn_base = "height:16px;font-size:9pt;color:white;border:0 solid #CCCCCC;cursor:hand;background-color:#2650A6;";
//翻年、月等的按钮
...
//日期选择控件体的样式
var s_sss_body = "width:150;background-color:#2650A6;display:none;z-index:9998;position:absolute;" +
"border-left:1 solid #CCCCCC;border-top:1 solid #CCCCCC;border-right:1 solid #999999;border-bottom:1 solid #999999;";
//显示日的td的样式
var s_sss_day = "width:21px;height:20px;background-color:#D8F0FC;font-size:10pt;";
//字体样式
var s_sss_font = "color:#FFCC00;font-size:9pt;cursor:hand;";
//链接的样式
var s_sss_link = "text-decoration:none;font-size:9pt;color:#2650A6;";
//横线
var s_sss_line = "border-bottom:1 solid #6699CC";
//------------------ 变量定义 ---------------------------//
...
document.write('<div align="center" id="divsssTurn" style="border:0;" isControled="true">');
...
document.write(' <tr style="background-color:#2650A6;font-size:10pt;color:white;height:22px;" isControled="true">');
for(var i =0;i < weekName.length;i ++){
//输出星期
document.write('<td width="21" align="center" isControled="true">' + weekName[i] + '</td>');
}
document.write(' </tr>');
...
sssWriteHead();
showTime();
var dads = document.all.divsssDate.style;
var iX, iY;

var h = document.all.divsssDate.offsetHeight;
var w = document.all.divsssDate.offsetWidth;
//计算left

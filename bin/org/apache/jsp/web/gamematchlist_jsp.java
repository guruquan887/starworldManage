...
public final class gamematchlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private org.apache.jasper.runtime.TagHandlerPool _005fjspx_005ftagPool_005fc_005fforEach_005fvar_005fitems_005fnobody;
  ...
  public void _jspInit() {
    _005fjspx_005ftagPool_005fc_005fforEach_005fvar_005fitems_005fnobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  ...
  public void _jspDestroy() {
    _005fjspx_005ftagPool_005fc_005fforEach_005fvar_005fitems_005fnobody.release();
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	if(request.getParameter("termOne")!=null){
      ...
      out.write("<title>管理中心-比赛管理</title>\r\n");
      ...
      out.write("/web/GameMatchInfoList.do?action=gameMatchList&curPage=\"+value+\"&nullity=");
      out.print(nullity );
      out.write("&pageSize=");
      out.print(pageSize );
      out.write("&termOne=\"+tone;\r\n");
      out.write("   }\r\n");
      out.write("   \r\n");
      out.write("function changepage(pageNo){\r\n");
      out.write("\tdocument.location.href=\"");
      out.print(request.getContextPath());
      out.write("/web/GameMatchInfoList.do?action=gameMatchList&curPage=\"+pageNo+\"&termOne=\"+tone+\"&nullity=");
      out.print(nullity );
      out.write("&pageSize=");
      out.print(pageSize );
      out.write("\";\r\n");
      out.write("}\r\n");
      out.write("function undoCheck(){\r\n");
      ...
      out.write("\tdocument.location.href=\"");
      out.print(request.getContextPath());
      out.write("/web/issueList.do?termOne=\"+encodeURI(document.all.termOne.value);\r\n");
      out.write("}\r\n");
      ...
      out.print(request.getContextPath());
      out.write("/web/issueDelete.do\";\r\n");
      out.write("\t  form2.submit();\r\n");
      out.write("   }\r\n");
      out.write("   else if(opId==1){\r\n");
      out.write("\t  form2.action=\"");
      out.print(request.getContextPath());
      out.write("/web/issueChangeState.do?action=pub\";\r\n");
      out.write("\t  form2.submit();  \r\n");
      out.write("   }\r\n");
      out.write("   else if(opId==2){\r\n");
      out.write("\t  form2.action=\"");
      out.print(request.getContextPath());
      out.write("/web/issueChangeState.do?action=unpub\";\r\n");
      out.write("\t  form2.submit();  \r\n");
      out.write("   }\r\n");
      out.write("\r\n");
      out.write("}\r\n");
      ...
      out.print(request.getContextPath());
      out.write("/web/issueList.do\">\r\n");
      out.write("        <label>\r\n");
      out.write("\t\t<select name=\"nullity\" id=\"nullity\" class=\"Select\" onchange=\"form1.submit()\" >\r\n");
      out.write("\t\t<option value=\"0\">发布</option>\r\n");
      out.write("\t\t<option value=\"1\">锁定</option>\r\n");
      out.write("        </select>\r\n");
      out.write("        <input type=\"text\" name=\"termOne\" id=\"termOne\" value=\"\" />\r\n");
      out.write("        <input name=\"Submit4\" type=\"button\" class=\"input\" value=\"搜索\" onClick=\"search()\"/>\r\n");
      out.write("        </label>\t  \r\n");
      out.write("\t\t");
      ...
      out.write("                  <input type=\"button\" name=\"Submit4\" class=\"input\" value=\"发布\" onclick=\"tjSubmit(1)\" />\r\n");
      out.write("                  <input type=\"button\" name=\"Submit5\" class=\"input\" value=\"锁定\" onclick=\"tjSubmit(2)\" />\r\n");
      out.write("              </div>            </td>\r\n");
      out.write("         </tr>\r\n");
      out.write("\t\t<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"table_margin\">\r\n");
      out.write("          <tr>\r\n");
      out.write("            <td width=\"60\" class=\"menutop\"><label>\r\n");
      out.write("              <input type=\"checkbox\" name=\"checkAll\" value=\"checkAll\" onClick=\"checkAllBox(0)\" />\r\n");
      out.write("            </label></td>\r\n");
      out.write("            <td width=\"60\" class=\"menutop\">比赛标识</td>\r\n");
      out.write("            <td class=\"menutop\">比赛名称</td>\r\n");
      out.write("            <td class=\"menutop\">比赛时间</td>\r\n");
      out.write("            <td class=\"menutop\">赛事状态</td>\r\n");
      out.write("            <td class=\"menutop\">冻结状态</td>\r\n");
      out.write("            <td class=\"menutop\">新增日期</td>\r\n");
      out.write("          </tr>\r\n");
      out.write("\t\t  ");
      //  c:forEach
      ...
      // /web/gamematchlist.jsp(158,4) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setVar("issue");
      // /web/gamematchlist.jsp(158,4) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${gameMatchlist}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("            <td class=\"tdcenter\"><label>\r\n");
            out.write("              <input type=\"checkbox\" name=\"checkbox\" value=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${issue.matchID}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
            out.write("\" />\r\n");
            out.write("            </label></td>\r\n");
            out.write("            <td onclick=\"window.location.href='");
            out.print(request.getContextPath());
            out.write("/web/issuePreUpdate.do?matchID=");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${issue.matchID}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
            out.write("'\" class=\"tdcenter\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${issue.matchID}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
            out.write("</td>\r\n");
            out.write("            <td onclick=\"window.location.href='");
            out.print(request.getContextPath());
            ...
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${issue.matchID}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
            out.write("'\" class=\"tdcenter\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${issue.matchTitle}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
            out.write("</td>\r\n");
            out.write("            <td onclick=\"window.location.href='");
            out.print(request.getContextPath());
            out.write("/web/issuePreUpdate.do?matchID=");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${issue.matchID}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
            out.write("'\" class=\"tdcenter\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${issue.applyBeginDate}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
            out.write("</td>\r\n");
            out.write("            <td onclick=\"window.location.href='");
            out.print(request.getContextPath());
            out.write("/web/issuePreUpdate.do?matchID=");
            ...
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${issue.matchID}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
            out.write("'\" class=\"tdcenter\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${issue.collectDate}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
            out.write("</td>\r\n");
            out.write("          </tr>\r\n");
            out.write("\t\t  ");
      ...
      out.write("          <tr>\r\n");
      out.write("\t\t  <tr>\r\n");
      out.write("                <td class=\"tdcenter\" colspan=\"28\" align=\"center\" valign=\"middle\" bgcolor=\"#FFFFFF\">\r\n");
      out.write("\t\t\t\t<font color=\"red\">");
      if (_jspx_meth_c_005fout_005f0(_jspx_page_context))
        return;
      out.write("</font></td>\r\n");
      out.write("       </tr>\r\n");
      out.write("            <td colspan=\"13\" class=\"tdright_new\">总记录:");
      ...
      out.write("var tcalc=document.getElementById(\"nullity\");\r\n");
      out.write("var index=\"");
      out.print(nullity );
      out.write("\";\r\n");
      out.write("for(var i=0; i<tcalc.options.length; i++){\r\n");
      out.write("\t\t\tif(tcalc.options[i].value==index){\r\n");
      out.write("\t\t\t\ttcalc.options[i].selected=true;break;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(PageContext _jspx_page_context)
    ...
    //  c:forEach
    org.apache.taglibs.standard.tag.rt.core.ForEachTag _jspx_th_c_005fforEach_005f0 = (org.apache.taglibs.standard.tag.rt.core.ForEachTag) _005fjspx_005ftagPool_005fc_005fforEach_005fvar_005fitems_005fnobody.get(org.apache.taglibs.standard.tag.rt.core.ForEachTag.class);
    _jspx_th_c_005fforEach_005f0.setPageContext(_jspx_page_context);
    _jspx_th_c_005fforEach_005f0.setParent(null);
    // /web/gamematchlist.jsp(130,2) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("r1");
    // /web/gamematchlist.jsp(130,2) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${class}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
    ...
    try {
      ...
      _005fjspx_005ftagPool_005fc_005fforEach_005fvar_005fitems_005fnobody.reuse(_jspx_th_c_005fforEach_005f0);
    }
    return false;
  }
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    // /web/gamematchlist.jsp(166,143) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${issue.matchStatus==0}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    // /web/gamematchlist.jsp(166,143) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    // /web/gamematchlist.jsp(166,201) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${issue.matchStatus==1}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    // /web/gamematchlist.jsp(166,201) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    // /web/gamematchlist.jsp(166,259) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${issue.matchStatus==2}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    // /web/gamematchlist.jsp(166,259) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    // /web/gamematchlist.jsp(167,143) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f3.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${issue.nullity==0}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    // /web/gamematchlist.jsp(167,143) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    // /web/gamematchlist.jsp(167,195) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f4.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${issue.nullity==1}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    // /web/gamematchlist.jsp(167,195) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f0(PageContext _jspx_page_context)
    ...
    // /web/gamematchlist.jsp(174,22) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f5(PageContext _jspx_page_context)
    ...
    // /web/gamematchlist.jsp(177,10) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /web/gamematchlist.jsp(177,10) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_c_005fif_005f5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        if (_jspx_meth_c_005fforEach_005f2(_jspx_th_c_005fif_005f5, _jspx_page_context))
          return true;
        out.write("\r\n");
        out.write("        </select> &nbsp;<a onClick=\"changepage(");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${page.curPage+1}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_005fforEach_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f5, PageContext _jspx_page_context)
    ...
    // /web/gamematchlist.jsp(181,10) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f2.setVar("i");
    // /web/gamematchlist.jsp(181,10) name = begin type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f2.setBegin(1);
    // /web/gamematchlist.jsp(181,10) name = end type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /web/gamematchlist.jsp(181,10) name = step type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f2, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f2)
    ...
    // /web/gamematchlist.jsp(182,14) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /web/gamematchlist.jsp(182,14) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null

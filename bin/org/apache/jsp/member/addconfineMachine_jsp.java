...
public final class addconfineMachine_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String msg="";
	if(request.getAttribute("msg")!=null){
      ...
      out.write("            {\r\n");
      out.write("                alert(\"机器不能为空！\");\r\n");
      out.write("                return false;\r\n");
      out.write("            } \r\n");
      out.write("            if(addrString.length()>33)\r\n");
      out.write("            {\r\n");
      out.write("                alert(\"机器字符长度不能超过33个字符！\");\r\n");
      out.write("                return false;\r\n");
      out.write("            }      \r\n");
      ...
      out.write("\t</span>新增—限制机器</div>\r\n");
      out.write("    <form id=\"myFormInfo\" name=\"myFormInfo\" method=\"post\" action=\"");
      out.print(request.getContextPath());
      out.write("/member/ConfineList.do?action=addconfineMachine\" onsubmit=\"return CheckFormInfo()\">\r\n");
      ...
      out.write("        </tr>\r\n");
      out.write("        <tr>\r\n");
      out.write("          <td class=\"menutop\">机器：</td>\r\n");

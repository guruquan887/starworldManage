...
public final class agentgoldQu_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(request.getParameter("accounts")!=null){
   accounts = request.getParameter("accounts");
      ...
      out.write("\t   alert(\"钱庄超出上限\");\r\n");
      out.write("\t   return false;\r\n");
      out.write("\t}\r\n");
      out.write("\tif(insureGold<0){\r\n");
      out.write("\t   alert(\"取出银子须大于0\");\r\n");
      out.write("\t   return false;\r\n");
      out.write("\t}\r\n");
      out.write("\tif(Number(gold)>Number(score)){\r\n");
      out.write("\t   alert(\"游戏超出上限\");\r\n");
      out.write("\t   return false;\r\n");
      out.write("\t}\r\n");
      out.write("\treturn true;\r\n");
      out.write(" \r\n");
      ...
      out.print(request.getContextPath());
      out.write("/member/gameAgentList.do?action=MemberQu\" onsubmit=\"return check()\">\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(PageContext _jspx_page_context)
    ...
    // /member/agentgoldQu.jsp(97,101) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /member/agentgoldQu.jsp(97,101) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null

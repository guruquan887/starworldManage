...
public final class goldCun_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(request.getAttribute("insureScore")!=null){
	insureScore = (Long)(request.getAttribute("insureScore"));
      ...
      out.write("    var xxgold = document.getElementById(\"xxgold\").value;\r\n");
      out.write("\tif(gold==\"\"){\r\n");
      out.write("\t   alert(\"请输入存入的银子\");\r\n");
      out.write("\t   return false;\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tif(parseFloat(gold)>parseFloat(xxgold)){\r\n");
      ...
      out.print(request.getContextPath());
      out.write("/member/gameuserList.do?action=MemberCun\" >\r\n");
      ...
      out.write("&nbsp;存<input name=\"insureGold\" id=\"insureGold\" type=\"text\" class=\"input_width2\" value=\"0\" onkeyup=\"isNumber(this)\" maxlength=\"11\" onKeyPress=\"return event.keyCode>=48&&event.keyCode<=57||event.keyCode==46\" onpaste=\"return !clipboardData.getData('text').match(/\\D/)\"\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(PageContext _jspx_page_context)
    ...
    // /member/goldCun.jsp(96,101) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${spreaderID!=3}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null, false)).booleanValue());
    // /member/goldCun.jsp(96,101) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null

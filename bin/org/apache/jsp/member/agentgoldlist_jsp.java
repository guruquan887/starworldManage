...
public final class agentgoldlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	if(request.getParameter("selectOne")!=null){
      ...
      out.write("/member/gamegoldList.do?action=gameGoldList&curPage=\" +value+\"&pageSize=");
      out.print(pageSize );
      out.write("&orderby=");
      out.print(orderby );
      out.write("&termOne=");
      ...
      out.print(request.getContextPath());
      out.write("/member/gamegoldList.do?action=gameGoldList&curPage=\"+pageNo+\"&termOne=\"+tone+\"&selectOne=");
      out.print(selectOne );
      out.write("&pageSize=");
      out.print(pageSize );
      out.write("\"+\"&orderby=");
      ...
      out.write("\tdocument.location.href=\"");
      out.print(request.getContextPath());
      out.write("/member/gamegoldList.do?action=gameGoldList&termOne=\"+encodeURI(document.all.termOne.value)\r\n");
      ...
      out.write("        </select>\r\n");
      out.write("\t\t<select name=\"interRoom\" id=\"interRoom\" class=\"input_width1\">\r\n");
      ...
      out.write("            <td class=\"menutop\" width=\"150\">用户名(游戏ID)</td>\r\n");
      out.write("            <td class=\"menutop\" width=\"80\">昵称</td>\r\n");
      out.write("            <td class=\"menutop\" width=\"100\">银子</td>\r\n");
      out.write("            <td class=\"menutop\" width=\"100\">钱庄</td>\r\n");
      out.write("            <td class=\"menutop\" width=\"150\">银子+钱庄</td>\r\n");
      out.write("            <td class=\"menutop\" width=\"80\">奖牌</td>\r\n");
      out.write("            <td class=\"menutop\" width=\"100\">魅力值</td>\r\n");
      out.write("            <td class=\"menutop\" width=\"150\">已兑换魅力</td>\r\n");
      out.write("            <td class=\"menutop\" width=\"80\">经验值</td>\r\n");
      out.write("            <td class=\"menutop\" width=\"120\">目前游戏</td>\r\n");
      out.write("            <td class=\"menutop\" width=\"120\">目前房间</td>\r\n");
      out.write("            <td class=\"menutop\" width=\"60\">税收</td>\r\n");
      out.write("            <td class=\"menutop\" width=\"60\">总局</td>\r\n");
      out.write("            <td class=\"menutop\" width=\"60\">赢局</td>\r\n");
      out.write("            <td class=\"menutop\" width=\"60\">输局</td>\r\n");
      out.write("            <td class=\"menutop\" width=\"60\">和局</td>\r\n");
      out.write("            <td class=\"menutop\" width=\"60\">逃局</td>\r\n");
      out.write("            <td class=\"menutop\" width=\"120\">登录次数</td>\r\n");
      out.write("            <td class=\"menutop\" width=\"170\">游戏时长(时)</td>\r\n");
      out.write("            <td class=\"menutop\" width=\"170\">在线时长(时)</td>\r\n");
      out.write("            <td class=\"menutop\" width=\"200\">最后登录时间</td>\r\n");
      out.write("            <td class=\"menutop\" width=\"150\">最后登录地址</td>\r\n");
      out.write("            ");
      out.write("\r\n");
      out.write("          </tr>\r\n");
      out.write("\t\t  ");
      ...
      // /member/agentgoldlist.jsp(204,4) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setVar("user");
      // /member/agentgoldlist.jsp(204,4) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("</td>\r\n");
            out.write("            <td class=\"tdcenter\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${user.userMedal}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
            out.write("</td>\r\n");
            out.write("            <td class=\"tdcenter\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${user.loveLiness}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
            out.write("</td>\r\n");
            out.write("            <td class=\"tdcenter\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${user.present}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
            out.write("</td>\r\n");
            out.write("            <td class=\"tdcenter\">");
            ...
            out.write("</td>\r\n");
            out.write("            <td class=\"tdcenter\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${user.totalCount}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
            out.write("</td>\r\n");
            out.write("            <td class=\"tdcenter\">");
            ...
            out.write("</td>\r\n");
            out.write("            <td class=\"tdcenter\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${user.drawCount}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
            out.write("</td>\r\n");
            out.write("            <td class=\"tdcenter\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${user.fleeCount}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
            out.write("</td>\r\n");
            out.write("            <td class=\"tdcenter\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${user.allLogonTimes}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
            out.write("</td>\r\n");
            out.write("            <td class=\"tdcenter\">");
            ...
            out.write("</td>\r\n");
            out.write("            <td class=\"tdcenter\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${user.lastLoginIP}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
            out.write("</td>\r\n");
            out.write("            ");
            out.write("\r\n");
            out.write("          </tr>\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("var ttype4=document.all.interRoom;\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(PageContext _jspx_page_context)
    ...
    // /member/agentgoldlist.jsp(234,8) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /member/agentgoldlist.jsp(234,8) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f0, PageContext _jspx_page_context)
    ...
    // /member/agentgoldlist.jsp(238,10) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f1.setVar("i");
    // /member/agentgoldlist.jsp(238,10) name = begin type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f1.setBegin(1);
    // /member/agentgoldlist.jsp(238,10) name = end type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /member/agentgoldlist.jsp(238,10) name = step type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    // /member/agentgoldlist.jsp(239,14) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /member/agentgoldlist.jsp(239,14) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null

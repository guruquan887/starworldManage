...
public final class gamePageItem_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	if(request.getParameter("selectOne")!=null){
      ...
      out.write("/game/gameSystem.do?action=gamePageItem&curPage=\" +value+\"&termOne=\"+encodeURI(document.all.termOne.value)+\"&selectOne=\"+document.all.selectOne.options[document.all.selectOne.selectedIndex].value;\r\n");
      out.write("   }\r\n");
      out.write("function changepage(pageNo){\r\n");
      out.write("\tdocument.location.href=\"");
      out.print(request.getContextPath());
      out.write("/game/gameSystem.do?action=gamePageItem&curPage=\"+pageNo+\"&termOne=\"+encodeURI(document.all.termOne.value)+\"&selectOne=\"+document.all.selectOne.options[document.all.selectOne.selectedIndex].value;\r\n");
      out.write("}\r\n");
      out.write("function search(){\r\n");
      out.write("\tdocument.location.href=\"");
      out.print(request.getContextPath());
      out.write("/game/gameSystem.do?action=gamePageItem&termOne=\"+encodeURI(document.all.termOne.value)\r\n");
      ...
      out.print(request.getContextPath());
      out.write("/game/gameSystem.do?action=gameGameItem\">\r\n");
      ...
      out.write("          <tr>\r\n");
      out.write("            <td colspan=\"11\" class=\"title\"><div align=\"left\"><a href=\"");
      out.print(request.getContextPath());
      out.write("/game/gameSystem.do?action=gameGameItem\">模块</a> <a href=\"");
      out.print(request.getContextPath());
      out.write("/game/gameSystem.do?action=gameTypeItem\">类型</a> <a href=\"");
      out.print(request.getContextPath());
      out.write("/game/gameSystem.do?action=gameKindItem\">游戏</a> <a href=\"");
      out.print(request.getContextPath());
      out.write("/game/gameSystem.do?action=gameNodeItem\">节点</a> <a href=\"");
      out.print(request.getContextPath());
      out.write("/game/gameSystem.do?action=gamePageItem\">自定义页</a></div></td>\r\n");
      out.write("          </tr>\r\n");
      out.write("          <tr>\r\n");
      out.write("            <td  class=\"menutop\"><input type=\"checkbox\" name=\"checkAll\" value=\"checkAll\" onClick=\"checkAllBox(0)\" /></td>\r\n");
      out.write("            <td class=\"menutop\">页面标识</td>\r\n");
      out.write("            <td class=\"menutop\">页面名称</td>\r\n");
      out.write("            <td class=\"menutop\">游戏名称</td>\r\n");
      out.write("            <td class=\"menutop\">节点名称</td>\r\n");
      out.write("            <td class=\"menutop\">操作类型</td>\r\n");
      out.write("            <td class=\"menutop\">排序</td>\r\n");
      out.write("            <td class=\"menutop\">资源路径</td>\r\n");
      ...
      out.write("\r\n");
      out.write("          <tr>\r\n");
      out.write("            <td colspan=\"11\" class=\"tdright_new\">总记录:");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(PageContext _jspx_page_context)
    ...
    // /game/gamePageItem.jsp(129,4) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("machine");
    // /game/gamePageItem.jsp(129,4) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${gamePagelist}", java.lang.Object.class, (PageContext)_jspx_page_context, null, false));
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${machine.gameID}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("\" name=\"checkbox\" /></td>\r\n");
          out.write("            <td class=\"tdcenter\">");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${machine.pageID}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("</td>\r\n");
          out.write("            <td class=\"tdcenter\">");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${machine.displayName}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("</td>\r\n");
          out.write("            <td class=\"tdcenter\">");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${machine.kindName}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("&nbsp;</td>\r\n");
          out.write("            <td class=\"tdcenter\">");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${machine.nodeName}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("&nbsp;</td>\r\n");
          out.write("            <td class=\"tdcenter\">操作类型");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${machine.operateType}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("&nbsp;</td>\r\n");
          out.write("            <td class=\"tdcenter\">");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${machine.sortID}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("&nbsp;</td>\r\n");
          out.write("            <td class=\"tdcenter\">");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${machine.responseUrl}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("&nbsp;</td>\r\n");
          out.write("            <td class=\"tdcenter\">");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${machine.nullityName}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("&nbsp;</td>\r\n");
          out.write("            <td class=\"tdcenter\">修改</td>\r\n");
          out.write("          </tr>\r\n");
          out.write("          ");
  ...
  private boolean _jspx_meth_c_005fif_005f0(PageContext _jspx_page_context)
    ...
    // /game/gamePageItem.jsp(143,5) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /game/gamePageItem.jsp(143,5) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f0, PageContext _jspx_page_context)
    ...
    // /game/gamePageItem.jsp(146,22) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f1(PageContext _jspx_page_context)
    ...
    // /game/gamePageItem.jsp(151,9) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /game/gamePageItem.jsp(151,9) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f1, PageContext _jspx_page_context)
    ...
    // /game/gamePageItem.jsp(155,10) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f1.setVar("i");
    // /game/gamePageItem.jsp(155,10) name = begin type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f1.setBegin(1);
    // /game/gamePageItem.jsp(155,10) name = end type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /game/gamePageItem.jsp(155,10) name = step type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    // /game/gamePageItem.jsp(156,14) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /game/gamePageItem.jsp(156,14) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null

...
<script language="javascript" src="<%=request.getContextPath()%>/js/Calendar1.js"></script>
</head>
	...
	<Div class="title">
	  ...
	  <input name="checkTime7" id="checkTime7" type="button" class="input" value="全部" onClick="searchtime('all')"/>
	   ...
	   <input name="proxyID" type="hidden" size="8" id="proxyID" value="<%=proxyID%>" />
		...
		<input name="startTime" id="startTime" onClick="WebCalendar();" type="text" value="${startTime}" size="15" />
至

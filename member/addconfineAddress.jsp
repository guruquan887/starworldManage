...
<body>
    ...
    <form id="myFormInfo" name="myFormInfo" method="post" action="<%=request.getContextPath()%>/member/ConfineList.do?action=addconfineAddress" onsubmit="return CheckFormInfo()">

...
<body>
	<div class="tab clearfix">
		<ul>
			<li class="active"><a href="<%=request.getContextPath()%>/member/gamegoldList.do?action=gamebankRecord">钱庄记录</a></li>
			<li><a href="<%=request.getContextPath()%>/member/gameuserList.do?action=SpreaderUserList">进出记录</a></li>
			<li><a href="<%=request.getContextPath()%>/member/gameuserList.do?action=SpreaderUserList">游戏记录</a></li>
			<li><a href="<%=request.getContextPath()%>/member/gameuserList.do?action=SpreaderUserList">充值记录</a></li>
		</ul>
	</div>

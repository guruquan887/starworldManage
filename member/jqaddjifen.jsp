...
<body>
    ...
    <form id="form1" name="form1" method="post" action="<%=request.getContextPath()%>/member/gamejquserList.do?action=zsJifen" onsubmit="return check()">
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_margin">
        ...
        <tr>
          <td class="menutop">赠送积分数目：</td>
          <td class="tdlefts"><label>
            <input name="type" id="type" type="hidden" value="<%=type%>" /><input name="gameTypeID" id="gameTypeID" type="hidden" value="<%=gameTypeID%>" /><input name="ss" id="ss" type="hidden" value="<%=ss%>" /><input name="score" id="score" type="text" class="input_width2" value="" onkeyup="isNumber(this)" onKeyPress="return event.keyCode>=48&&event.keyCode<=57||event.keyCode==46" onpaste="return !clipboardData.getData('text').match(/\D/)"

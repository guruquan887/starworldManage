	  ...
	  <form id="form1" name="form1" method="post" onsubmit="return submted()" action="<%=request.getContextPath()%>/gold/gamegoldList.do?action=rechargeRecord">
	   <input name="termOne" type="text" class="input_width2" id="termOne" />
	    <select name="selectOne" class="input_width1" id="selectOne">
	      <option value="accounts">按订单号码</option>
	      <option value="gameID">按交易号码</option>
        </select>

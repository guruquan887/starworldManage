...
import com.keno8.struts.dto.MenuDTO;
...
public class AuthorityDb {
	...
	public String init(int fid, int userid) {
		StringBuffer bf = new StringBuffer("<form id=\"form1\" name=\"form1\" ><table  cellpadding=\"2\" cellspacing=\"1\" border=\"0\" width=\"100%\" align=\"center\">");
	...
	public String SetContantFirst(int fid,int userid) {
		...
		try {
			...
			while (rs.next()) {
				...
				if(comfunc==1)
				{
					r+="<div class=\"Left1\" ><a href=\"#here\" onClick=\"SetContantSecond("+id+",0);\">"+rs.getString("cdname")

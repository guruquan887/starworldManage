...
<body>
    ...
    <form id="form1" name="form1" method="post" onSubmit="return newsaddcheck()" action="<%=request.getContextPath()%>/web/issueAdd.do">
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_margin">
        ...
        <tr>
          ...
          <td class="tdlefts"><label>
            <input name="issuetitle" type="text" size="50" style="width:400px"/>
          </label></td>
        </tr>
        <tr>
          <td class="tdright_new">禁用状态：</td>
          <td class="tdlefts"><label>
              <input type="radio" name="nullity" value="0" checked="checked"/>
          否
          <input type="radio" name="nullity" value="1" />
          是</label></td>
        </tr>
